...
class AppointmentDateInputsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PlatformChecker.isMobile() ? buildForMobile() : Row(
  ...
  Widget buildForMobile() {
    return Column(
      ...
      children: [
        DateInputWidget(
          label: 'ETA',
          onChanged: (date) => appointment.estimatedTimeOfArrival.value = date,
          dateInitialValue: appointment?.estimatedTimeOfArrival,
        ),
        DateInputWidget(
          label: 'ETB',
          onChanged: (date) => appointment.estimatedTimeOfBerthing.value = date,
          dateInitialValue: appointment?.estimatedTimeOfBerthing,
        ),
        DateInputWidget(
          label: 'ETS',
          onChanged: (date) => appointment.estimatedTimeOfSailing.value = date,
          dateInitialValue: appointment?.estimatedTimeOfSailing,
        ),
        DateInputWidget(
          label: 'Arrival',
