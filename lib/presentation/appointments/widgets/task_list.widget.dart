              ...
              rows: appointment.tasks.map((e) {
                return DataRow(
                  ...
                  cells: PlatformChecker.isMobile()
                      ? [
                          DataCellWidget(
                              text: e.name.value, width: MediaQuery.of(context).size.width * 0.2),
                          DataCellWidget(
                              text: e.taskStatus, width: MediaQuery.of(context).size.width * 0.3),
                        ]
                      : [
                          DataCellWidget(
                              text: e.name.value, width: double.infinity),
                          DataCellWidget(
                          ...
                          DataCellWidget(
                              ...
                              width: double.infinity),
                          DataCellWidget(
                              text: e.taskStatus, width: double.infinity),
                        ],
                );
              }).toList(),
            );
